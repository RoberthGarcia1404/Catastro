<section class="footer">
      <div class="footer-box">
        ...
        <div class="social">
          ...
          <a
            href="https://www.youtube.com/@alcaldiadechiquinquirapren2664"
            target="_blank"
          >
      ...
      <div class="footer-box">
        ...
        <div class="contact">
          <span
            ><i class="bx bxs-map"></i>Centro administrartivo Municipal, bloque
            2, Primer Piso/ Chiquinquirá - Boyacá</span
          >
          <span><i class="bx bxs-phone"></i>60(8) 7262531</span>
          <span
            ><i class="bx bxs-time"></i>Lunes a Jueves de 8am a 12m y de 2pm a
            6pm</span
          >
          <span
            ><i class="bx bxs-envelope"></i
            >gestorcatastral@chiquinquira-boyaca.gov.co</span
          >
        </div>
      </div>
      <div class="footer box">
